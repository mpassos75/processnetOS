  var worldData = {
                'CAPÃO DA CANOA': {
                    'EBAB-ETA-ETE-US': ["LAB REGIONAL","ETA-CAPÃO DA CANOA 1",	"ETA-CAPÃO DA CANOA 2", "EBAB-CURUMIM", "ETA-CURUMIM",	"ETE-ARAÇÁ (OU 1)",	"ETE-SÃO JORGE (OU 2)",	"ETE-GUARANI"],                    
                    EBE: ["EBE-0.1 GUARANI","EBE-1 BEIRA MAR I",	"EBE-2 BEIRA MAR II",	"EBE-2.1 PREFEITURA",	"EBE-3 GAL. OSÓRIO",	"EBE-3.6 PINDORAMA",	"EBE-3.2 SANTA LUZIA (II)",	"EBE-3.1 SANTO ANTÔNIO (I)","EBE-7.1 CONDADO I", "EBE-7.2 CONDADO II", "EBE-8 DUBAI", "EBE-9 CAPÃO DA CANOA ILHAS RESORT",	"EBE-9.1 CAPÃO DA CANOA ILHAS RESORT",	"EBE-9.2 CAPÃO DA CANOA ILHAS RESORT",	"EBE-9.3 CAPÃO DA CANOA ILHAS RESORT",	"EBE-10 CAMINITO", "EBE-14(FORUM)",	"EBE-30 COSTA SERENA", "EBE-PROV(SANTA)"],					
					RES: ["R33 (II)-BOM JESUS",	"R35 (III)-CENTRO",	"R36-JARDIM OLÍVIA",	"R37-JARDIM ATLÂNTICO(PRAIA AZUL)",	"R01-US",	"R02-US",	"R03-US",	"R04-ZONA NOVA",	"R05-ETA-2",	"R06-ETA-2",	"R07-STA LUZIA",	"R19-ETA-2",	"R22-GUARANI",	"R24-ARAÇÁ",	"R31 (0)-ETA CURUMIM",	"R32 (1)-ETA CURUMIM",	"R34 (4)-ARROIO TEXEIRA"],
					US: ["OUTROS"], 
                },
                'TORRES': {
		...
		function Colab() {
        var nFun = ["ALVARO JULIANO","ANDRE C W BIAZETTO","DEIVID G A FONTOURA","EDSON ROCHA","GELSON VIEIRA","JOSE R JOB MORAES","Marcos Schneider","NELSON JEAN"];
        var html = "";
